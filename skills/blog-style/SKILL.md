...
1. Hook: the problem or tension, in the reader's words; promise the payoff and preview it.
2. Stakes: why it matters now.
3. Payoff: the idea/solution, with one concrete example.
4. Close: the single takeaway, then one focused next step. No "in conclusion".
...
- `references/banned-words.json`: the words and phrases to avoid on this surface. Check the draft against this list before handing it back.

## Layers on top of

The companion `writing-quality` skill in this catalog carries the surface-independent rules: AI tells, plain-English swaps, front-loading, concrete over abstract, voice. Load it too; this skill only adds what's specific to blog posts.
