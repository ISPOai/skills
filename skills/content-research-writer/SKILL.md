...
Open the preferred coding/writing agent from this directory and start writing.
...
1. **Work in a local project**: Better than a browser-only assistant for long-form writing
