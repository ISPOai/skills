...
```
# Original
https://cdn.pixelbin.io/v2/round-dust-e06b92/original/agent-skill/hero.png

# Resize to 1024×1024
https://cdn.pixelbin.io/v2/round-dust-e06b92/t.resize(h:1024,w:1024)/agent-skill/hero.png

# Resize → WebP (chained with ~)
https://cdn.pixelbin.io/v2/round-dust-e06b92/t.resize(h:1024,w:1024)~t.toFormat(f:webp)/agent-skill/hero.png
```
...
> Always defer to **[pixelbin.io/docs](https://www.pixelbin.io/docs?utm_source=github&utm_medium=skill-catalog)** for the live catalog and any new transforms or plugins.
