...
For full input schemas, see [pixelbin.io/docs](https://www.pixelbin.io/docs?utm_source=github&utm_medium=skill-catalog).
...
For the live, authoritative list, always check **[pixelbin.io/docs](https://www.pixelbin.io/docs?utm_source=github&utm_medium=skill-catalog)**.
...
| --- | --- | --- |
| `Insufficient credits` / `Usage Limit Exceeded` | Out of credits / plan quota | [Top up / upgrade](https://www.pixelbin.io/pricing?utm_source=github&utm_medium=skill-catalog) |
