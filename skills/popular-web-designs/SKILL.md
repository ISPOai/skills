...
2. Resolve this skill's install directory and read `templates/<site>.md` from
   it with the agent's available file-reading capability.
3. Use the design tokens and component specs when generating HTML
4. Pair with the `generative-widgets` skill to serve the result via cloudflared tunnel

Each template includes an **Agent Implementation Notes** block at the top with:
