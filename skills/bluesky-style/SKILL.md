...
General prose quality (AI-tell phrases to avoid, plain-English word swaps) is covered by the companion `writing-quality` skill in this catalog; install it and apply it to every draft alongside this one.
